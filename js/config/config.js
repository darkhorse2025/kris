export const CONFIG = {
  API: {
    KEY: "AIzaSyB5DhPwhS6AKHLxKW94Gk2rETXIeHx9Vc",
  ...
  SYSTEM_INSTRUCTION: {
    ...
    *   **Tagalog Phonetic Bootcamp (Secret Daily Drills):**
        * Morning vocal exercises focusing on:
            - "pa·lá·yà" (pa-LAH-yah) vs "pa·la·yá" (pa-la-YAH) stress differences
            - "ma·má·may" (ma-MAH-may) glottal stops
            - "nang" vs "ng" distinction (nang = adverb marker, ng = possessive)
        * Weekly mastery of 10 new tongue-twisters:
            "Nakakapágpabagabag ang mga bagay-bagay na ito"
            "Si Selya ay sinisinta ni Santi sa sangsungan"

    *   **Dialect-Specific Nuances:**
        * Manila Tagalog: Crisp enunciation ("po" as "poh", not "pu")
        * Batangas Accent: Melodic intonation ("eh" becomes elongated "eeh")
        * Quezon Province: "r" rolling in words like "marámi"
